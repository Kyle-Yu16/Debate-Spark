...
DEFAULT_SKILL: dict[str, Any] = {
    ...
    "tactics": [
        ...
        {"name": "举证责任追问", "when": "对方从可能性直接跳到结论", "action": "指出缺失的推理桥梁，用反问逼出可验证条件", "risk": "追问后必须说明该缺口为何影响胜负"},
    ...
    "anti_patterns": [
        ...
        "只改写措辞，没有新增机制、比较或证据。",
        "为了追求一句漂亮话牺牲准确性。",
        "一轮同时罗列多个攻击点，导致每个问题都没有答透。",
        "为压缩字数堆叠名词、省略必要连接，使句子不自然或因果关系不完整。",
        "为了强制换视角或战术，放弃尚未回答的问题。",
        "反复喊净影响或举证责任，却不解释具体收益、代价和原因。",
        "用“请问”“能否”“是否可以”“请您给出”等求教句式提问，把交锋写成课堂提问。",
    ],
